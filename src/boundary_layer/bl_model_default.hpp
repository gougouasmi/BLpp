#ifndef PROFILE_FUNCTIONS_DEFAULT_HPP
#define PROFILE_FUNCTIONS_DEFAULT_HPP
...
inline void initialize_default(ProfileParams &profile_params,
                               vector<double> &state) {
...
double
limit_update_default(const Generic::Vector<double, CTIME_RANK> &state,
...
template <std::size_t CTIME_RANK = 0>
double compute_rhs_default(const Generic::Vector<double, CTIME_RANK> &state,
...
template <std::size_t CTIME_RANK = 0>
double compute_full_rhs_default(
    const Generic::Vector<double, CTIME_RANK> &state, int state_offset,
    const vector<double> &field, int field_offset,
    Generic::Vector<double, CTIME_RANK> &rhs, const ProfileParams &params) {
  double romu = 1.0;
...
template <std::size_t CTIME_RANK = 0>
void compute_rhs_jacobian_default(
    const Generic::Vector<double, CTIME_RANK> &state, int state_offset,
    const vector<double> &field, int field_offset,
...
inline void compute_outputs_default(const vector<double> &state_grid,
