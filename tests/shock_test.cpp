...
void NormalShockRatios() {
  ...
  ratios = cpg_shock_ratios(15.0, 1.1);
...
void ObliqueShockRatios() {
  ShockRatios ratios = cpg_shock_ratios(4.0, 1.7, 0.25 * M_PI);
